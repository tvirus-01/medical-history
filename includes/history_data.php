<!-- SELECT ".$bkly_tp."ab_appointments.id, ".$bkly_tp."ab_appointments.end_date, ".$bkly_tp."ab_customers.id, ".$bkly_tp."ab_customers.full_name, ".$bkly_tp."ab_customers.phone, ".$bkly_tp."ab_customers.email, ".$bkly_tp."ab_customer_appointments.customer_id, ".$bkly_tp."ab_customer_appointments.appointment_id, ".$bkly_tp."ab_customer_appointments.status, ".$bkly_tp."ab_services.title, ".$bkly_tp."ab_staff.full_name 
FROM ".$bkly_tp."ab_customers, ".$bkly_tp."ab_appointments, ".$bkly_tp."ab_customer_appointments, ".$bkly_tp."ab_services, ".$bkly_tp."ab_staff
WHERE ".$bkly_tp."ab_appointments.id = ".$bkly_tp."ab_customer_appointments.appointment_id AND ".$bkly_tp."ab_customers.id = ".$bkly_tp."ab_customer_appointments.customer_id AND ".$bkly_tp."ab_appointments.service_id = ".$bkly_tp."ab_services.id AND ".$bkly_tp."ab_appointments.staff_id = ".$bkly_tp."ab_staff.id -->
 <head>
